...
public class PerfPerformanceController extends BaseController
{
    ...
    {
        return success(perfPerformanceService.selectPerfPerformanceByPerformanceId(performanceId));
    }
    ...
    {
        return toAjax(perfPerformanceService.deletePerfPerformanceByPerformanceIds(performanceIds));
    }
}
