<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="templateList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="模板类型(KPI:关键指标, OKR:目标与成果, COMPETENCY:能力素质)" align="center" prop="templateType" />
      <el-table-column label="适用部门ID" align="center" prop="deptId" />
      <el-table-column label="适用岗位IDS" align="center" prop="postIds" />
...
import { listTemplate, getTemplate, delTemplate, addTemplate, updateTemplate } from "@/api/performance/template"
